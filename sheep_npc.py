...
class SheepNPC(pygame.sprite.Sprite):
    ...
    def __init__(self):
        ...
        sprite_sheet = SpriteSheet("sheep_walk.png")

        #loads up facing images onto the list
        image = sprite_sheet.get_image(0, 0, 128, 128)
        self.walking_frames_up.append(image)
        image = sprite_sheet.get_image(128, 0, 128, 128)
        self.walking_frames_up.append(image)
        image = sprite_sheet.get_image(256, 0, 128, 128)
        self.walking_frames_up.append(image)
        image = sprite_sheet.get_image(384, 0, 128, 128)
        self.walking_frames_up.append(image)
        ...
        image = sprite_sheet.get_image(0, 256, 128, 128)
        self.walking_frames_down.append(image)
        image = sprite_sheet.get_image(128, 256, 128, 128)
        self.walking_frames_down.append(image)
        image = sprite_sheet.get_image(256, 256, 128, 128)
        self.walking_frames_down.append(image)
        image = sprite_sheet.get_image(384, 256, 128, 128)
        self.walking_frames_down.append(image)
